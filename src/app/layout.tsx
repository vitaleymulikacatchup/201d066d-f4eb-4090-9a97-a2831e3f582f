...
export const metadata: Metadata = {
  title: "Ejovik - Fine Dining Restaurant & Culinary Excellence",
  description: "Experience exceptional fine dining at Ejovik. Award-winning cuisine, elegant ambiance, and impeccable service. Reserve your table today.",
  keywords: "fine dining restaurant, gourmet cuisine, upscale dining, restaurant reservations, culinary excellence",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Ejovik - Fine Dining Restaurant",
    description: "Discover culinary excellence at Ejovik. Premium dining experience with innovative dishes and exceptional service.",
    type: "website",
    siteName: "Ejovik",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34yEatLQt6B9A82mZgfqKsKaLO9/uploaded-1765819009216-0gp4m80w.jpg",
        alt: "Ejovik signature dish"
      }
    ]
  },
  twitter: {
    ...
    title: "Ejovik Fine Dining Restaurant",
    description: "Experience extraordinary cuisine and elegant dining at Ejovik.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34yEatLQt6B9A82mZgfqKsKaLO9/uploaded-1765819009216-0gp4m80w.jpg"]
  }
};
